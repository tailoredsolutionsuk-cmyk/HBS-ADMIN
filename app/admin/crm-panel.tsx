...
type CrmData = { clients: Client[]; clientAnalytics: ClientAnalytics[]; leads: Lead[]; tasks: Task[]; notes: Note[]; activities: Activity[]; permissions: { canEdit: boolean }; metrics: { clients: number; openLeads: number; pipelineValue: number; weightedValue: number; overdueFollowUps: number; tasksDue: number } };
